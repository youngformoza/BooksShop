...
ALTER TABLE author_to_book ADD CHECK ( authors_id_author = 1 );

ALTER TABLE author_to_book ADD CHECK ( books_products_id_product = 1 );
...
ALTER TABLE authors ADD CHECK ( id_author = 1 );

ALTER TABLE authors ADD CHECK ( popularity BETWEEN 0 AND 7753000000 );
...
ALTER TABLE book_cover_types ADD CHECK ( id_cover_book = 1 );
...
ALTER TABLE book_forms ADD CHECK ( id_form = 1 );
...
ALTER TABLE books ADD CHECK ( products_id_product = 1 );

ALTER TABLE books ADD CHECK ( book_forms_id_form = 1 );

ALTER TABLE books ADD CHECK ( paper_types_id_paper_type = 1 );

ALTER TABLE books ADD CHECK ( book_cover_types_id_cover_book = 1 );

ALTER TABLE books ADD CHECK ( genres_id_genre = 1 );
...
ALTER TABLE customers ADD CHECK ( id_customer = 1 );

ALTER TABLE customers ADD CHECK ( age BETWEEN 14 AND 99 );
...
ALTER TABLE employees ADD CHECK ( id_employee = 1 );

ALTER TABLE employees ADD CHECK ( age BETWEEN 14 AND 99 );

ALTER TABLE employees ADD CHECK ( experince BETWEEN 0 AND 60 );

ALTER TABLE employees ADD CHECK ( positions_id_position = 1 );
...
ALTER TABLE genres ADD CHECK ( id_genre = 1 );
...
ALTER TABLE gift_cards ADD CHECK ( products_id_product = 1 );

ALTER TABLE gift_cards ADD CHECK ( types_of_cover_id_cover_cards = 1 );
...
ALTER TABLE orders ADD CHECK ( id_order = 1 );

ALTER TABLE orders ADD CHECK ( discount BETWEEN 0 AND 100 );

ALTER TABLE orders ADD CHECK ( employees_id_employee = 1 );

ALTER TABLE orders ADD CHECK ( customers_id_customer = 1 );
...
ALTER TABLE paper_types ADD CHECK ( id_paper_type = 1 );

ALTER TABLE paper_types ADD CONSTRAINT paper_types_pk PRIMARY KEY ( id_paper_type );
...
ALTER TABLE positions ADD CHECK ( id_position = 1 );
...
ALTER TABLE product_to_order ADD CHECK ( products_id_product = 1 );

ALTER TABLE product_to_order ADD CHECK ( orders_id_order = 1 );
...
ALTER TABLE products ADD CHECK ( id_product = 1 );
...
ALTER TABLE stationary_types ADD CHECK ( id_type_stat = 1 );
...
ALTER TABLE stationery ADD CHECK ( products_id_product = 1 );

ALTER TABLE stationery ADD CHECK ( stationary_types_id_type_stat = 1 );
...
ALTER TABLE types_of_cover ADD CHECK ( id_cover_cards = 1 );
