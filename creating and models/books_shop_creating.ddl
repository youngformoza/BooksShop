...
CREATE TABLE books (
    ...
    paper_type_id_paper      INTEGER NOT NULL,
    cover_book_id_cover_book INTEGER NOT NULL,
...
ALTER TABLE cover_book ADD CONSTRAINT cover_book_pk PRIMARY KEY ( id_cover_book );
...
ALTER TABLE paper_type ADD CONSTRAINT paper_type_pk PRIMARY KEY ( id_paper );
...
ALTER TABLE stationary_type ADD CONSTRAINT stationary_type_pk PRIMARY KEY ( id_type_stat );

CREATE TABLE stationery (
    products_id_product          INTEGER NOT NULL,
    name                         VARCHAR2(30) NOT NULL,
    stationary_type_id_type_stat INTEGER NOT NULL
);
...
ALTER TABLE books
    ADD CONSTRAINT books_cover_book_fk FOREIGN KEY ( cover_book_id_cover_book )
        REFERENCES cover_book ( id_cover_book );
...
ALTER TABLE books
    ADD CONSTRAINT books_paper_type_fk FOREIGN KEY ( paper_type_id_paper )
        REFERENCES paper_type ( id_paper );
...
ALTER TABLE stationery
    ADD CONSTRAINT stationery_stationary_type_fk FOREIGN KEY ( stationary_type_id_type_stat )
        REFERENCES stationary_type ( id_type_stat );
